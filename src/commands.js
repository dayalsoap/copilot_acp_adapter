...
const COMMAND_DESCRIPTIONS = Object.freeze({
  ...
  "/sandbox": "Inspect or manage command sandboxing",
  "/blame": "Trace code history with Git blame and linked Copilot sessions",
  "/every": "Schedule a recurring prompt or skill for this session",
  "/after": "Schedule a one-time prompt or skill for this session",
